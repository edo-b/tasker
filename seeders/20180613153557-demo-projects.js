...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    return await queryInterface.bulkInsert('Task', [
        { title: 'Finish backend', color: 'red', status: 'todo', projectId: projectIds[0].id },
        { title: 'Handle errors on client', color: 'green', status: 'todo', projectId: projectIds[0].id },
        { title: 'Create seed data', color: 'blue', status: 'doing', projectId: projectIds[0].id },
        ...
        { title: 'Authentication and authorization', color: 'yellow', status: 'todo', projectId: projectIds[0].id }
    ], {});
  },
